...
homeIndexModule.controller('newTopicController', ["$scope", "$http", "$window", "dataService",
...
homeIndexModule.controller('singleTopicController', ["$scope", "dataService", "$window", "$routeParams",
